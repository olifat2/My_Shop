...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/olivierfatombi/Desktop/prog/dev/webSite/boutiqueEnLigne/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./home/olivierfatombi/Desktop/prog/dev/webSite/boutiqueEnLigne/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'web','api',);
        registerArgumentsSet('routes', 'home','accueil','register.form','register',
'login.form','login','logout','admin.dashboard','technique.save.store',
'effet.save.store','nature.save.store','admin.products.index','admin.products.create','admin.products.store',
'admin.products.show','admin.products.edit','admin.products.update','admin.products.destroy','admin.orders.index',
'admin.orders.create','admin.orders.store','admin.orders.show','admin.orders.edit','admin.orders.update',
'admin.orders.destroy','admin.clients.index','admin.clients.create','admin.clients.store','admin.clients.show',
'admin.clients.edit','admin.clients.update','admin.clients.destroy','client.dashboard','storage.local',);
        registerArgumentsSet('views', 
'admin.dashboard','admin.products.create','admin.products.edit','admin.products.index','admin.products.show',
'auth.login','auth.register','client.dashboard','home','layouts.app',
'layouts.auth-admin.app','layouts.auth-admin.header','layouts.header','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
